export function Footer() {
  return (
    <footer className="mt-24 border-t border-white/10 bg-[#040816]">
        ...
        <div className="grid gap-10 md:grid-cols-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-sm text-slate-400">
                  Plataforma de resultados e palpites
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-400">
              ...
              <li>
                <a href="/bancas" className="transition hover:text-white">
                  Bancas
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/palpites" className="transition hover:text-white">
                  Tendências
                </a>
              </li>
            </ul>
